...
from cfp.core.auction.transcript import PoseidonMerkleTree
...
def benchmark_scoring() -> List[BenchmarkResult]:
    ...
    from cfp.core.auction.scoring import compute_utility_transfer
...
def benchmark_auction_simulation() -> List[BenchmarkResult]:
    ...
    from cfp.core.auction.commit_reveal import SolverCommit
